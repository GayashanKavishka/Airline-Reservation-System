...
const FlightRoute = ({ isAdmin }) => {
    ...
    const handleRemove = (Aircraft_ID) => {
        axios
            ...
            .catch((err) => console.error("Error deleting aircraft:", err));
    };
    ...
    const planeDetails = planes.map((item, index) => (
        <tr key={index} className="even:bg-gray-800 odd:bg-gray-700 text-white">
            <td className="px-4 py-2 border border-gray-700">{item.Route_ID}</td>
            <td className="px-4 py-2 border border-gray-700">{item.Departure_Airport_ID}</td>
            <td className="px-4 py-2 border border-gray-700">{item.Departure_Airport_Name}</td>
            <td className="px-4 py-2 border border-gray-700">{item.Arrival_Airport_ID}</td>
            <td className="px-4 py-2 border border-gray-700">{item.Arrival_Airport_Name}</td>
            <td className="px-4 py-2 border border-gray-700">{item.Distance}</td>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-gray-800 rounded-lg shadow-lg">
                    <div className="flex justify-between items-center p-4 border-b border-gray-700">
                        <h4 className="text-xl font-semibold">Flight Routes</h4>
                        <Link
                            to="/admin/add-routes"
                        ...
                        <table className="table-auto w-full border-collapse border border-gray-700">
                            <thead>
                                <tr className="bg-gray-700 text-left">
                                    <th className="px-4 py-2 border border-gray-700">Route ID</th>
                                    <th className="px-4 py-2 border border-gray-700">Departure Airport ID</th>
                                    <th className="px-4 py-2 border border-gray-700">Departure Airport Name</th>
                                    <th className="px-4 py-2 border border-gray-700">Arrival Airport ID</th>
                                    <th className="px-4 py-2 border border-gray-700">Arrival Airport Name</th>
                                    <th className="px-4 py-2 border border-gray-700">Distance</th>
